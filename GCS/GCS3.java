 ...
 * @author cppuav
 */
public class GCS3 extends ApplicationTemplate{
    ...
    public static class AnimationThread extends Thread {
        ...
        protected GCS3.AppFrame appFrame;
        private int id;    
        private boolean stop = false;
        private boolean running = false;
        //ArrayList<Position> pathPositions = new ArrayList<Position>();

        public AnimationThread(int id, GCS3.AppFrame appFrame) {
            this.id = id;
    ...
    public static void main(String[] args)
    {
        ...
        final AppFrame af = (AppFrame) start("WorldWind GCS3", GCS3.AppFrame.class);
