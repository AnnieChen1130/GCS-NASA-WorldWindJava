 ...
 * @author cppuav
 */
public class GCS2 extends ApplicationTemplate{
    ...
    public static class AnimationThread extends Thread {
        ...
        protected GCS2.AppFrame appFrame;
        private int id;    
        private boolean stop = false;
        private boolean running = false;

        public AnimationThread(int id, GCS2.AppFrame appFrame) {
            this.id = id;
            ...
            if(id == 0){
                ...
                while (!stop) {
                    ...
                    try {
                        ...
                        currentLat += 0.0001;
                        currentLon += 0.0001;
                        placemark.setPosition(Position.fromDegrees(currentLat, currentLon, currentElev));
                        wwd.redraw();
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
    ...
    public static void main(String[] args)
    {
        ...
        final AppFrame af = (AppFrame) start("WorldWind GCS2", GCS2.AppFrame.class);
