 ...
 * @author cppuav
 */
public class GCS6 extends ApplicationTemplate{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private boolean ClickedXbeeConnectButton = false;
        private final XbeeMain xbee1 = new XbeeMain();
        private Map<Integer,String> id_ICAOList=new HashMap<>();
        private Map<String,Integer> ICAO_idList=new HashMap<>();
        ...
        private JPanel makeConnectionPanel() {
            ...
            xbeeButton.addActionListener((ActionEvent actionEvent) -> {
                if (ClickedXbeeConnectButton == false){
                    xbeeButton.setText("Disconnect Xbee");
                    xbee1.connectGCSXbee();
                    ClickedXbeeConnectButton = true;
                } else{
                    xbeeButton.setText("Connect Xbee");
                    xbee1.closeXbeePort();
                    ClickedXbeeConnectButton = false;
                }
            });            
        ...
        private JPanel newVehicleConnectionPanel(int numOfVehicle){
            ...
            enterButton.addActionListener((ActionEvent actionEvent) -> {
                id_ICAOList.put(vehicleNum-1, IDinput.getText());
                ICAO_idList.put(IDinput.getText(),vehicleNum-1);
        ...
        public boolean getClickXbeeConnectButton(){
            return this.ClickedXbeeConnectButton;
        }
        ...
        public String getid_ICAOnum(int id){
            return this.id_ICAOList.get(id);
        }
        
        public int getICAO_id(String ICAO){
            return this.ICAO_idList.get(ICAO);
        }
        
        public Map<String,Integer> getICAO_idList(){
            return this.ICAO_idList;
        }
    ...
    public static class AnimationThread extends Thread {
        ...
        protected GCS6.AppFrame appFrame;
        ...
        public AnimationThread(int id, GCS6.AppFrame appFrame) {
            this.id = id;
        ...
        public void setXbeeData(Map<String, String> map){
            this.mMap = map;
        }
        ...
        public void run() {
            ...
            String threadICAO = appFrame.getid_ICAOnum(id);
            
            while(this.mMap.isEmpty()){}
            ...
            try{
                while(!stop){
                    ...
                    String receiveICAO = this.mMap.get("ICAO");//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    public static void main(String[] args)
    {
        ...
        final AppFrame af = (AppFrame) start("WorldWind GCS6", GCS6.AppFrame.class);

        Map<Integer, AnimationThread> threadList=new HashMap<>(); 
        final XbeeMain xbee = af.getXbee();
        ...
        while(true){            
            ...
            if(af.getClickXbeeConnectButton()){
                String msg;
                msg = xbee.receiveUAVXbeeData();  
                ...
                System.out.println(receiveICAO);
                int threadID;
                if(af.getICAO_idList().containsKey(receiveICAO)){
                    threadID = af.getICAO_id(receiveICAO);
                    if(threadList.containsKey(threadID)){
                        threadList.get(threadID).setXbeeData(mMap);
                    }                    
                }                
